...
def main():
    parser = argparse.ArgumentParser(description="Göktürk UAV - Raspberry Pi 5 Grayscale Stream Test")
    ...
    print("==================================================")
    print(" Göktürk UAV - Raspberry Pi 5 Grayscale Test")
    ...
    try:
        ...
        while True:
            ...
            if not args.no_gui:
                cv2.imshow("Raspberry Pi 5 Grayscale Feed", gray_frame)
